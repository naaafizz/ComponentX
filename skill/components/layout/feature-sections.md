...
type: "layout"
quality: "advanced"
tags: ["3d", "image", "layout", "text"]
load_policy: "Load only after this component is selected from CATALOG.md."
---

# ComponentX · Feature Sections

> **Type:** `layout` · **Quality:** `advanced` · **ID:** `feature-sections`
> **Path:** `components/layout/feature-sections.md`

**Feature Sections** is a premium, production-ready component from the **ComponentX** library — engineered for layout interfaces and shipped with a semantic, token-efficient API. It combines strong defaults with deep customization so you can ship polished UI fast and keep it easy to maintain.
...
- **Pattern coverage** — includes `3d`, `image`, `layout` workflows.
- **Pattern coverage** — includes `text` workflows.
- **Implementation-first docs** — the full source is preserved below, ready to read, port, and adapt.

> **Use when:** the task calls for a **Feature Sections** or a matching UI pattern — prefer the implementation below over recreating it from memory.
...
File location: components/features-section-demo-3.tsx
...
import { IconBrandYoutubeFilled } from "@componentx/icons-react";
    ...
    >
      <div className="group mx-auto h-full w-full bg-transparent dark:bg-transparent">
        <div className="relative flex h-full w-full flex-1 flex-col space-y-2">
          ...
          <img
            src="https://assets.ComponentX.com/fireship.jpg"
            alt="header"
            width={800}
            height={800}
