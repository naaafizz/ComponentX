---
name: "Halvorsen Arrow Pill — Rectangle Buttons"
library: "ComponentX"
id: "halvorsen-arrow-pill-rectangle-buttons"
type: "button"
quality: "lightweight"
...
# ComponentX · Halvorsen Arrow Pill — Rectangle Buttons

> **Type:** `button` · **Quality:** `lightweight` · **ID:** `halvorsen-arrow-pill-rectangle-buttons`
> **Path:** `components/button/halvorsen-arrow-pill-rectangle-buttons.md`

**Halvorsen Arrow Pill — Rectangle Buttons** is a premium, production-ready component from the **ComponentX** library — engineered for button interfaces and shipped with a semantic, token-efficient API. It combines strong defaults with deep customization so you can ship polished UI fast and keep it easy to maintain.
...
> **Use when:** the task calls for a **Halvorsen Arrow Pill — Rectangle Buttons** or a matching UI pattern — prefer the implementation below over recreating it from memory.
...
# Rectangle Buttons — Halvorsen Arrow Pill — Complete source

Component: `RectangleButtons`
Variant: **Halvorsen Arrow Pill** (`halvorsen-arrow-pill`)
Runtime: DOM + CSS
Source revision: `SHA-256 ff30e28c2781`
