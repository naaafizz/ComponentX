---
name: "Halftone Relay — Laser"
library: "ComponentX"
id: "halftone-relay-laser"
type: "button"
quality: "showcase"
...
# ComponentX · Halftone Relay — Laser

> **Type:** `button` · **Quality:** `showcase` · **ID:** `halftone-relay-laser`
> **Path:** `components/button/halftone-relay-laser.md`

**Halftone Relay — Laser** is a premium, production-ready component from the **ComponentX** library — engineered for button interfaces and shipped with a semantic, token-efficient API. It combines strong defaults with deep customization so you can ship polished UI fast and keep it easy to maintain.
...
> **Use when:** the task calls for a **Halftone Relay — Laser** or a matching UI pattern — prefer the implementation below over recreating it from memory.
...
# Laser — Halftone Relay — Complete source

Component: `LaserCollection`
Variant: **Halftone Relay** (`halftone-relay`)
Runtime: Raw WebGL
Source revision: `SHA-256 70cc015d5175`
