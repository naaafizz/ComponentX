---
name: "Dot Border Button — Rectangle Buttons"
library: "ComponentX"
id: "dot-border-button-rectangle-buttons"
type: "button"
quality: "lightweight"
...
# ComponentX · Dot Border Button — Rectangle Buttons

> **Type:** `button` · **Quality:** `lightweight` · **ID:** `dot-border-button-rectangle-buttons`
> **Path:** `components/button/dot-border-button-rectangle-buttons.md`

**Dot Border Button — Rectangle Buttons** is a premium, production-ready component from the **ComponentX** library — engineered for button interfaces and shipped with a semantic, token-efficient API. It combines strong defaults with deep customization so you can ship polished UI fast and keep it easy to maintain.
...
> **Use when:** the task calls for a **Dot Border Button — Rectangle Buttons** or a matching UI pattern — prefer the implementation below over recreating it from memory.
...
# Rectangle Buttons — Dot Border Button — Complete source

Component: `RectangleButtons`
Variant: **Dot Border Button** (`dot-border-button`)
Runtime: DOM + CSS
Source revision: `SHA-256 ff30e28c2781`
...
Role: canonical-source · 395 lines · 12243 bytes · SHA-256 `eb3ef1de8c8af80bf3f532630c60ed4ee90f10cd645d136f284417e75bda6584`
