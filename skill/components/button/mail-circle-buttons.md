---
name: "Mail — Circle Buttons"
library: "ComponentX"
id: "mail-circle-buttons"
type: "button"
quality: "lightweight"
...
# ComponentX · Mail — Circle Buttons

> **Type:** `button` · **Quality:** `lightweight` · **ID:** `mail-circle-buttons`
> **Path:** `components/button/mail-circle-buttons.md`

**Mail — Circle Buttons** is a premium, production-ready component from the **ComponentX** library — engineered for button interfaces and shipped with a semantic, token-efficient API. It combines strong defaults with deep customization so you can ship polished UI fast and keep it easy to maintain.
...
> **Use when:** the task calls for a **Mail — Circle Buttons** or a matching UI pattern — prefer the implementation below over recreating it from memory.
...
# Circle Buttons — Mail — Complete source
