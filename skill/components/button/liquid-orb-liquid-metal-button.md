---
name: "Liquid Orb — Liquid Metal Button"
library: "ComponentX"
...
# ComponentX · Liquid Orb — Liquid Metal Button

> **Type:** `button` · **Quality:** `showcase` · **ID:** `liquid-orb-liquid-metal-button`
> **Path:** `components/button/liquid-orb-liquid-metal-button.md`

**Liquid Orb — Liquid Metal Button** is a premium, production-ready component from the **ComponentX** library — engineered for button interfaces and shipped with a semantic, token-efficient API. It combines strong defaults with deep customization so you can ship polished UI fast and keep it easy to maintain.
...
> **Use when:** the task calls for a **Liquid Orb — Liquid Metal Button** or a matching UI pattern — prefer the implementation below over recreating it from memory.
...
# Liquid Metal Button — Liquid Orb — Complete source

Component: `LiquidMetalButton`
Variant: **Liquid Orb** (`circle`)
Runtime: Raw WebGL 2 + DOM/CSS
Source revision: `SHA-256 76624e881a3a`
