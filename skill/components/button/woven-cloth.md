...
# ComponentX · Woven Cloth

> **Type:** `button` · **Quality:** `showcase` · **ID:** `woven-cloth`
> **Path:** `components/button/woven-cloth.md`

**Woven Cloth** is a premium, production-ready component from the **ComponentX** library — engineered for button interfaces and shipped with a semantic, token-efficient API. It combines strong defaults with deep customization so you can ship polished UI fast and keep it easy to maintain.
...
> **Use when:** the task calls for a **Woven Cloth** or a matching UI pattern — prefer the implementation below over recreating it from memory.
...
# Woven Cloth — Woven Cloth — Complete source

Component: `WovenCloth`
Variant: **Woven Cloth** (`woven-cloth`)
Runtime: Three.js r160
Source revision: `SHA-256 9bfd56ef7579`
