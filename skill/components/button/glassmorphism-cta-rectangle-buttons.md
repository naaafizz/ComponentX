---
name: "Glassmorphism CTA — Rectangle Buttons"
library: "ComponentX"
id: "glassmorphism-cta-rectangle-buttons"
type: "button"
quality: "lightweight"
...
# ComponentX · Glassmorphism CTA — Rectangle Buttons

> **Type:** `button` · **Quality:** `lightweight` · **ID:** `glassmorphism-cta-rectangle-buttons`
> **Path:** `components/button/glassmorphism-cta-rectangle-buttons.md`

**Glassmorphism CTA — Rectangle Buttons** is a premium, production-ready component from the **ComponentX** library — engineered for button interfaces and shipped with a semantic, token-efficient API. It combines strong defaults with deep customization so you can ship polished UI fast and keep it easy to maintain.
...
> **Use when:** the task calls for a **Glassmorphism CTA — Rectangle Buttons** or a matching UI pattern — prefer the implementation below over recreating it from memory.
...
# Rectangle Buttons — Glassmorphism CTA — Complete source

Component: `RectangleButtons`
Variant: **Glassmorphism CTA** (`glassmorphism-cta`)
Runtime: DOM + CSS
Source revision: `SHA-256 ff30e28c2781`
...
Role: canonical-source · 151 lines · 8068 bytes · SHA-256 `b535a5f6e778924906fa1625cf610841b847d52c17487dad83215dd5921a3863`
