---
name: "Sliding Text CTA — Rectangle Buttons"
library: "ComponentX"
...
# ComponentX · Sliding Text CTA — Rectangle Buttons

> **Type:** `button` · **Quality:** `lightweight` · **ID:** `sliding-text-cta-rectangle-buttons`
> **Path:** `components/button/sliding-text-cta-rectangle-buttons.md`

**Sliding Text CTA — Rectangle Buttons** is a premium, production-ready component from the **ComponentX** library — engineered for button interfaces and shipped with a semantic, token-efficient API. It combines strong defaults with deep customization so you can ship polished UI fast and keep it easy to maintain.
...
> **Use when:** the task calls for a **Sliding Text CTA — Rectangle Buttons** or a matching UI pattern — prefer the implementation below over recreating it from memory.
