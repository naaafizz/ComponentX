...
# ComponentX · Google Gemini Effect

> **Type:** `button` · **Quality:** `standard` · **ID:** `google-gemini-effect`
> **Path:** `components/button/google-gemini-effect.md`

**Google Gemini Effect** is a premium, production-ready component from the **ComponentX** library — engineered for button interfaces and shipped with a semantic, token-efficient API. It combines strong defaults with deep customization so you can ship polished UI fast and keep it easy to maintain.
...
> **Use when:** the task calls for a **Google Gemini Effect** or a matching UI pattern — prefer the implementation below over recreating it from memory.
