...
type: "button"
quality: "standard"
tags: ["button", "component", "input", "navigation", "text"]
load_policy: "Load only after this component is selected from CATALOG.md."
---

# ComponentX · Combobox

> **Type:** `button` · **Quality:** `standard` · **ID:** `combobox`
> **Path:** `components/button/combobox.md`

**Combobox** is a premium, production-ready component from the **ComponentX** library — engineered for button interfaces and shipped with a semantic, token-efficient API. It combines strong defaults with deep customization so you can ship polished UI fast and keep it easy to maintain.
...
- **Pattern coverage** — includes `button`, `input`, `navigation` workflows.
- **Pattern coverage** — includes `text` workflows.
- **Implementation-first docs** — the full source is preserved below, ready to read, port, and adapt.

> **Use when:** the task calls for a **Combobox** or a matching UI pattern — prefer the implementation below over recreating it from memory.
...
import { Tab, Tabs } from "componentx-ui/components/tabs";
...
import {
  ...
  ComboboxEmpty,
  ComboboxTrigger
} from "@/components/componentx/core/combobox";
