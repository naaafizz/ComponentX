---
name: "Engraved Certificate"
library: "ComponentX"
id: "engraved-certificate"
type: "button"
quality: "advanced"
tags: ["animated", "animation", "background", "button", "component", "shader", "text", "webgl"]
load_policy: "Load only after this component is selected from CATALOG.md."
---

# ComponentX · Engraved Certificate

> **Type:** `button` · **Quality:** `advanced` · **ID:** `engraved-certificate`
> **Path:** `components/button/engraved-certificate.md`

**Engraved Certificate** is a premium, production-ready component from the **ComponentX** library — engineered for button interfaces and shipped with a semantic, token-efficient API. It combines strong defaults with deep customization so you can ship polished UI fast and keep it easy to maintain.
...
> **Use when:** the task calls for a **Engraved Certificate** or a matching UI pattern — prefer the implementation below over recreating it from memory.
...
# Engraved Certificate — Complete source

Component: `EngravedCertificate`
Runtime: Canvas 2D + DOM/CSS
Source revision: `SHA-256 dc48266f23df`
...
```tsx
import { EngravedCertificate } from "@componentx/threeui";
...
Role: canonical-source · 576 lines · 15442 bytes · SHA-256 `dc48266f23df7fe6580eaf68cc0ad378bda6ed87abd71cdc972e2ec4dc768394`
