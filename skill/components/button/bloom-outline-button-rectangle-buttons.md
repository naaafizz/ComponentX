---
name: "Bloom Outline Button — Rectangle Buttons"
library: "ComponentX"
id: "bloom-outline-button-rectangle-buttons"
type: "button"
quality: "lightweight"
...
# ComponentX · Bloom Outline Button — Rectangle Buttons

> **Type:** `button` · **Quality:** `lightweight` · **ID:** `bloom-outline-button-rectangle-buttons`
> **Path:** `components/button/bloom-outline-button-rectangle-buttons.md`

**Bloom Outline Button — Rectangle Buttons** is a premium, production-ready component from the **ComponentX** library — engineered for button interfaces and shipped with a semantic, token-efficient API. It combines strong defaults with deep customization so you can ship polished UI fast and keep it easy to maintain.
...
> **Use when:** the task calls for a **Bloom Outline Button — Rectangle Buttons** or a matching UI pattern — prefer the implementation below over recreating it from memory.
...
# Rectangle Buttons — Bloom Outline Button — Complete source

Component: `RectangleButtons`
Variant: **Bloom Outline Button** (`bloom-outline-button`)
Runtime: DOM + CSS
Source revision: `SHA-256 ff30e28c2781`
