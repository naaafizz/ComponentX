---
name: "Launch Button — Rectangle Buttons"
library: "ComponentX"
id: "launch-button-rectangle-buttons"
type: "button"
quality: "lightweight"
...
# ComponentX · Launch Button — Rectangle Buttons

> **Type:** `button` · **Quality:** `lightweight` · **ID:** `launch-button-rectangle-buttons`
> **Path:** `components/button/launch-button-rectangle-buttons.md`

**Launch Button — Rectangle Buttons** is a premium, production-ready component from the **ComponentX** library — engineered for button interfaces and shipped with a semantic, token-efficient API. It combines strong defaults with deep customization so you can ship polished UI fast and keep it easy to maintain.
...
> **Use when:** the task calls for a **Launch Button — Rectangle Buttons** or a matching UI pattern — prefer the implementation below over recreating it from memory.
...
# Rectangle Buttons — Launch Button — Complete source

Component: `RectangleButtons`
Variant: **Launch Button** (`launch-button`)
Runtime: DOM + CSS
Source revision: `SHA-256 ff30e28c2781`
...
Role: canonical-source · 126 lines · 5289 bytes · SHA-256 `db8303b70c0322d0c7877b32e8230ce906111ee746fa5460f8aeedf59915a900`
