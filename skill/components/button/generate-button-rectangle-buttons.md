---
name: "Generate Button — Rectangle Buttons"
library: "ComponentX"
...
# ComponentX · Generate Button — Rectangle Buttons

> **Type:** `button` · **Quality:** `lightweight` · **ID:** `generate-button-rectangle-buttons`
> **Path:** `components/button/generate-button-rectangle-buttons.md`

**Generate Button — Rectangle Buttons** is a premium, production-ready component from the **ComponentX** library — engineered for button interfaces and shipped with a semantic, token-efficient API. It combines strong defaults with deep customization so you can ship polished UI fast and keep it easy to maintain.
...
> **Use when:** the task calls for a **Generate Button — Rectangle Buttons** or a matching UI pattern — prefer the implementation below over recreating it from memory.
...
# Rectangle Buttons — Gradient Beam CTA — Complete source
...
Role: canonical-source · 150 lines · 6428 bytes · SHA-256 `90a5961c1e7374ecf1d4efa1e3ef051048a08567933491a91c67280d4eac9a42`
