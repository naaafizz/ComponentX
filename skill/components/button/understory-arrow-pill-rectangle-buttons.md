---
name: "Understory Arrow Pill — Rectangle Buttons"
library: "ComponentX"
id: "understory-arrow-pill-rectangle-buttons"
type: "button"
quality: "lightweight"
...
# ComponentX · Understory Arrow Pill — Rectangle Buttons

> **Type:** `button` · **Quality:** `lightweight` · **ID:** `understory-arrow-pill-rectangle-buttons`
> **Path:** `components/button/understory-arrow-pill-rectangle-buttons.md`

**Understory Arrow Pill — Rectangle Buttons** is a premium, production-ready component from the **ComponentX** library — engineered for button interfaces and shipped with a semantic, token-efficient API. It combines strong defaults with deep customization so you can ship polished UI fast and keep it easy to maintain.
...
> **Use when:** the task calls for a **Understory Arrow Pill — Rectangle Buttons** or a matching UI pattern — prefer the implementation below over recreating it from memory.
...
# Rectangle Buttons — Attune Thermal — Complete source

Component: `RectangleButtons`
Variant: **Attune Thermal** (`attune-thermal`)
Runtime: DOM + CSS
Source revision: `SHA-256 ff30e28c2781`
