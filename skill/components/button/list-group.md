...
# ComponentX · List Group

> **Type:** `button` · **Quality:** `standard` · **ID:** `list-group`
> **Path:** `components/button/list-group.md`

**List Group** is a premium, production-ready component from the **ComponentX** library — engineered for button interfaces and shipped with a semantic, token-efficient API. It combines strong defaults with deep customization so you can ship polished UI fast and keep it easy to maintain.
...
> **Use when:** the task calls for a **List Group** or a matching UI pattern — prefer the implementation below over recreating it from memory.
...
<div
  ...
  <a href="#" class="link link-primary flex items-center no-underline">
    <span class="icon-[componentx--activity] me-3 size-5"></span>
      Active
  </a>
  <a href="#" class="link hover:link-primary flex items-center no-underline">
    <span class="icon-[componentx--link] me-3 size-5"></span>
      Link
  </a>
  <a href="#" class="link flex items-center no-underline" disabled>
    <span class="icon-[componentx--ban] me-3 size-5"></span>
      Disabled
  </a>
</div>
```
...
<ul class="border-base-content/25 divide-base-content/25 w-96 divide-y rounded-md border *:p-3 *:first:rounded-t-md *:last:rounded-b-md">
  <li class="flex items-center ">
    <span class="icon-[componentx--user] text-base-content me-3 size-5"></span>
    Recent Posts
  </li>
  <li class="flex items-center">
    <span class="icon-[componentx--calendar-event] text-base-content me-3 size-5"></span>Upcoming Events
  </li>
  <li class="flex items-center">
    <span class="icon-[componentx--message] text-base-content me-3 size-5"></span>Notifications
  </li>
</ul>
```
I'm using the ComponentX Tailwind CSS component library in my project. Please integrate the following component into my project:
    ...
    <li class="flex items-start">
      <div class="avatar avatar-placeholder me-3">
        <div class="bg-info text-info-content w-10 rounded-lg">
          <span class="icon-[componentx--brand-tailwind] size-6"></span>
        </div>
      </div>
      <div class="grow">
    ...
    <li class="flex items-start">
      <div class="avatar avatar-placeholder me-3">
        <div class="bg-success text-success-content w-10 rounded-lg">
          <span class="icon-[componentx--brand-vue] size-6"></span>
        </div>
      </div>
      <div class="grow">
    ...
    <li class="flex items-start">
      <div class="avatar avatar-placeholder me-3">
        <div class="bg-error text-error-content w-10 rounded-lg">
          <span class="icon-[componentx--brand-angular] size-6"></span>
        </div>
      </div>
      <div class="grow">
    ...
    <li class="flex items-start">
      <div class="avatar avatar-placeholder me-3">
        <div class="bg-primary text-primary-content w-10 rounded-lg">
          <span class="icon-[componentx--brand-react] size-6"></span>
        </div>
      </div>
      <div class="grow">
...
<div class="card w-80">
  ...
  <li class="flex items-center px-4 py-2.5">
    <span class="icon-[componentx--user] me-2 size-5"></span>
    Profile
  </li>
  <li class="flex items-center px-4 py-2.5">
    <span class="icon-[componentx--settings] me-2 size-5"></span>
    Settings
  </li>
  <li class="flex items-center px-4 py-2.5">
    <span class="icon-[componentx--file-dollar] me-2 size-5"></span>
    Billing Plans
  </li>
  <li class="flex items-center px-4 py-2.5">
    <span class="icon-[componentx--currency-dollar] me-2 size-5"></span>
    Pricing
  </li>
  <li class="flex items-center px-4 py-2.5">
    <span class="icon-[componentx--question-mark] me-2 size-5"></span>
    FAQ
  </li>
</div>
```
...
<div class="card w-80">
  ...
  <ul class="space-y-0.5">
    ...
    <li class="flex items-center justify-between px-4 py-2.5">
      <div class="flex items-center gap-2">
        <img src="https://cdn.flyonui.com/fy-assets/components/social-icon/componentx.png" alt="dribble" class="size-5" />
...
<div class="card w-96">
  ...
  <li class="flex items-center gap-2 px-4 py-2.5">
    ...
    <div class="flex grow items-center justify-between gap-y-1">
      ...
      <div class="action max-sm:mt-1">
        <button class="btn btn-soft btn-sm max-sm:btn-square"> <span class="icon-[componentx--send]"></span> <span class="max-sm:hidden">Send</span> </button>
      </div>
    </div>
  </li>
  <li class="flex items-center gap-2 px-4 py-2.5">
