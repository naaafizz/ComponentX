...
type: "3d"
quality: "showcase"
tags: ["3d", "animation", "shader", "webgl"]
load_policy: "Load only after this component is selected from CATALOG.md."
---

# ComponentX · Cloud Shader

> **Type:** `3d` · **Quality:** `showcase` · **ID:** `cloud-shader`
> **Path:** `components/3d/cloud-shader.md`

**Cloud Shader** is a premium, production-ready component from the **ComponentX** library — engineered for 3D interfaces and shipped with a semantic, token-efficient API. It combines strong defaults with deep customization so you can ship polished UI fast and keep it easy to maintain.
...
- **Pattern coverage** — includes `3d`, `animation`, `shader` workflows.
- **Pattern coverage** — includes `webgl` workflows.
- **Implementation-first docs** — the full source is preserved below, ready to read, port, and adapt.

> **Use when:** the task calls for a **Cloud Shader** or a matching UI pattern — prefer the implementation below over recreating it from memory.
...
File location: components/cloud-shader-demo.tsx
...
File location: components/ui/cloud-shader.tsx
...
// Original cloud shader for ComponentX.
