...
# ComponentX · Shader Buttons

> **Type:** `3d` · **Quality:** `showcase` · **ID:** `shader-buttons`
> **Path:** `components/3d/shader-buttons.md`

**Shader Buttons** is a premium, production-ready component from the **ComponentX** library — engineered for 3D interfaces and shipped with a semantic, token-efficient API. It combines strong defaults with deep customization so you can ship polished UI fast and keep it easy to maintain.
...
> **Use when:** the task calls for a **Shader Buttons** or a matching UI pattern — prefer the implementation below over recreating it from memory.
...
# Shader Buttons — Star Portal — Complete source
