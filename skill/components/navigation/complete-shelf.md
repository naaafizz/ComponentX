...
type: "navigation"
quality: "showcase"
tags: ["3d", "animation", "component", "data", "layout", "media", "navigation", "shader", "text"]
load_policy: "Load only after this component is selected from CATALOG.md."
---

# ComponentX · Complete Shelf

> **Type:** `navigation` · **Quality:** `showcase` · **ID:** `complete-shelf`
> **Path:** `components/navigation/complete-shelf.md`

**Complete Shelf** is a premium, production-ready component from the **ComponentX** library — engineered for navigation interfaces and shipped with a semantic, token-efficient API. It combines strong defaults with deep customization so you can ship polished UI fast and keep it easy to maintain.
...
- **Pattern coverage** — includes `layout`, `media`, `navigation` workflows.
- **Pattern coverage** — includes `shader`, `text` workflows.
- **Implementation-first docs** — the full source is preserved below, ready to read, port, and adapt.

> **Use when:** the task calls for a **Complete Shelf** or a matching UI pattern — prefer the implementation below over recreating it from memory.
...
# Complete Shelf — Complete source
...
```tsx
import { CompleteShelfLandingPage } from "@componentx/threeui";
...
Role: canonical-source · 5932 lines · 900296 bytes · SHA-256 `606f200fed8602c243f40a11c8c364f0e625c57f80e7c97dc76419da207f198e`
  ...
  <main class="experience" id="experience">
    ...
    <section class="browse-ui" id="browse-ui" aria-label="Shelf navigation">
      ...
      <div class="browse-actions">
        <button class="round-button" id="previous" type="button" aria-label="Previous volume">
        ...
        <button class="round-button" id="next" type="button" aria-label="Next volume">
          <svg viewBox="0 0 16 16" aria-hidden="true"><path d="m5.5 3.5 4.5 4.5-4.5 4.5"></path></svg>
        </button>
      </div>

      <nav class="index-nav" aria-label="Volume index">
        <div class="markers" id="markers" role="tablist" aria-label="Choose a volume"></div>
    ...
    <aside
      ...
      inert
    >
      <button class="close-button" id="close-detail" type="button" aria-label="Return volume to shelf">
    ...
    <section class="static-fallback" id="static-fallback" aria-labelledby="fallback-title" hidden>
      ...
      <div class="fallback__grid" aria-label="Seven conceptual hardcovers">
        ...
        <article class="fallback-book" style="--book-color:#da3b2f;--book-foil:#ff8eab;--book-height:385px"><span>Volume VI</span><strong>ComponentX</strong></article>
  ...
  <script type="module">
    ...
    const BOOKS = [
      ...
      },
      {
        ...
        deck: "A studio notebook for ComponentX: compose responsive pages directly in the medium, then tune type, layout, and interaction until motion feels native to the structure.",
        binding: "Coral cloth · copper foil",
        format: "146 × 224 mm · imagined edition",
        theme: "ComponentX · composition through motion",
        motif: "Folded frames",
        motifKey: "frames",
    ...
    const COVER_ATLAS_DATA = "data:image/webp;base64,";
