---
name: "Gradient CTA — Rectangle Buttons"
library: "ComponentX"
id: "gradient-cta-rectangle-buttons"
type: "background"
quality: "lightweight"
...
# ComponentX · Gradient CTA — Rectangle Buttons

> **Type:** `background` · **Quality:** `lightweight` · **ID:** `gradient-cta-rectangle-buttons`
> **Path:** `components/background/gradient-cta-rectangle-buttons.md`

**Gradient CTA — Rectangle Buttons** is a premium, production-ready component from the **ComponentX** library — engineered for background interfaces and shipped with a semantic, token-efficient API. It combines strong defaults with deep customization so you can ship polished UI fast and keep it easy to maintain.
...
> **Use when:** the task calls for a **Gradient CTA — Rectangle Buttons** or a matching UI pattern — prefer the implementation below over recreating it from memory.
...
# Rectangle Buttons — Generate Button — Complete source

Component: `RectangleButtons`
Variant: **Generate Button** (`generate-button`)
Runtime: DOM + CSS
Source revision: `SHA-256 ff30e28c2781`
...
Role: canonical-source · 525 lines · 15542 bytes · SHA-256 `e99ab802a1e1f1a7b1444727e26197c43f8cfe328ca6e2cd45b6fbb3bce694c6`
