---
name: "Speedometer — Performance Gauges"
library: "ComponentX"
id: "speedometer-performance-gauges"
type: "form"
quality: "advanced"
tags: ["animation", "background", "button", "card", "form", "shader", "text", "webgl"]
load_policy: "Load only after this component is selected from CATALOG.md."
---

# ComponentX · Speedometer — Performance Gauges

> **Type:** `form` · **Quality:** `advanced` · **ID:** `speedometer-performance-gauges`
> **Path:** `components/form/speedometer-performance-gauges.md`

**Speedometer — Performance Gauges** is a premium, production-ready component from the **ComponentX** library — engineered for form interfaces and shipped with a semantic, token-efficient API. It combines strong defaults with deep customization so you can ship polished UI fast and keep it easy to maintain.
...
- **Pattern coverage** — includes `card`, `form`, `shader` workflows.
- **Pattern coverage** — includes `text`, `webgl` workflows.
- **Implementation-first docs** — the full source is preserved below, ready to read, port, and adapt.

> **Use when:** the task calls for a **Speedometer — Performance Gauges** or a matching UI pattern — prefer the implementation below over recreating it from memory.
...
# Performance Gauges — Speedometer — Complete source

Component: `PerformanceGauges`
Variant: **Speedometer** (`speedometer`)
Runtime: DOM + CSS
Source revision: `SHA-256 2dc25058fc85`
...
```tsx
import { PerformanceGauges } from "@componentx/threeui";
...
Role: canonical-source · 802 lines · 45113 bytes · SHA-256 `2dc25058fc852c71880641050fbb6555d9934023f5b00c0ad21ef0899ef3cda4`
