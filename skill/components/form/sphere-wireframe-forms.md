---
name: "Sphere — Wireframe Forms"
library: "ComponentX"
id: "sphere-wireframe-forms"
type: "form"
quality: "advanced"
...
# ComponentX · Sphere — Wireframe Forms

> **Type:** `form` · **Quality:** `advanced` · **ID:** `sphere-wireframe-forms`
> **Path:** `components/form/sphere-wireframe-forms.md`

**Sphere — Wireframe Forms** is a premium, production-ready component from the **ComponentX** library — engineered for form interfaces and shipped with a semantic, token-efficient API. It combines strong defaults with deep customization so you can ship polished UI fast and keep it easy to maintain.
...
> **Use when:** the task calls for a **Sphere — Wireframe Forms** or a matching UI pattern — prefer the implementation below over recreating it from memory.
...
# Wireframe Forms — Sphere — Complete source
