---
name: "Dot Matrix — Structure Flow"
library: "ComponentX"
id: "dot-matrix-structure-flow"
type: "form"
quality: "advanced"
...
# ComponentX · Dot Matrix — Structure Flow

> **Type:** `form` · **Quality:** `advanced` · **ID:** `dot-matrix-structure-flow`
> **Path:** `components/form/dot-matrix-structure-flow.md`

**Dot Matrix — Structure Flow** is a premium, production-ready component from the **ComponentX** library — engineered for form interfaces and shipped with a semantic, token-efficient API. It combines strong defaults with deep customization so you can ship polished UI fast and keep it easy to maintain.
...
> **Use when:** the task calls for a **Dot Matrix — Structure Flow** or a matching UI pattern — prefer the implementation below over recreating it from memory.
...
# Structure Flow — Dot Matrix — Complete source
...
Role: component · 19 lines · 3754 bytes · SHA-256 `d8d36607f51c766a128d61d2a5d8b456613480b7144bfe7fd7759ee6f2693de2`
...
Role: shader-source · 34 lines · 1053 bytes · SHA-256 `53f37fc94c15f8f4d7f52c4308d0438fff547257d7dd8a190ede873750d087e6`
