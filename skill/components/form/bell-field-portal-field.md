---
name: "Bell Field — Portal Field"
library: "ComponentX"
id: "bell-field-portal-field"
type: "form"
quality: "standard"
tags: ["animation", "form", "shader", "text", "webgl"]
load_policy: "Load only after this component is selected from CATALOG.md."
---

# ComponentX · Bell Field — Portal Field

> **Type:** `form` · **Quality:** `standard` · **ID:** `bell-field-portal-field`
> **Path:** `components/form/bell-field-portal-field.md`

**Bell Field — Portal Field** is a premium, production-ready component from the **ComponentX** library — engineered for form interfaces and shipped with a semantic, token-efficient API. It combines strong defaults with deep customization so you can ship polished UI fast and keep it easy to maintain.
...
- **Pattern coverage** — includes `animation`, `form`, `shader` workflows.
- **Pattern coverage** — includes `text`, `webgl` workflows.
- **Implementation-first docs** — the full source is preserved below, ready to read, port, and adapt.

> **Use when:** the task calls for a **Bell Field — Portal Field** or a matching UI pattern — prefer the implementation below over recreating it from memory.
...
# Portal Field — Bell Field — Complete source

Component: `PortalFieldCollection`
Variant: **Bell Field** (`bell-field`)
Runtime: Three.js r134 + Raw WebGL + Canvas 2D
Source revision: `SHA-256 f90e34f83d51`
...
Role: component · 28 lines · 7085 bytes · SHA-256 `0dc1e82bc63c720662ed0559145b80b46429246bc0c83e7709b237ae93030452`
...
Role: shader-source · 73 lines · 3230 bytes · SHA-256 `a56c1f01fbb935744ed00b83a6812517aca142c88730dd044644feeb0d2a4b82`
