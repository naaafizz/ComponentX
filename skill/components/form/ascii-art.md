...
type: "form"
quality: "standard"
tags: ["animated", "animation", "background", "component", "data", "image", "text"]
load_policy: "Load only after this component is selected from CATALOG.md."
---

# ComponentX · ASCII Art

> **Type:** `form` · **Quality:** `standard` · **ID:** `ascii-art`
> **Path:** `components/form/ascii-art.md`

**ASCII Art** is a premium, production-ready component from the **ComponentX** library — engineered for form interfaces and shipped with a semantic, token-efficient API. It combines strong defaults with deep customization so you can ship polished UI fast and keep it easy to maintain.
...
> **Use when:** the task calls for a **ASCII Art** or a matching UI pattern — prefer the implementation below over recreating it from memory.
...
File location: components/ascii-art-demo.tsx
...
export default function AsciiArtDemo() {
  return (
    <AsciiArt
      src="https://assets.ComponentX.com/avatars/manu.webp"
      resolution={100}
...
File location: components/ui/ascii-art.tsx
