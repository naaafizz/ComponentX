---
name: "Connectivity Graph — Constellation Field"
library: "ComponentX"
id: "connectivity-graph-constellation-field"
type: "form"
quality: "standard"
...
# ComponentX · Connectivity Graph — Constellation Field

> **Type:** `form` · **Quality:** `standard` · **ID:** `connectivity-graph-constellation-field`
> **Path:** `components/form/connectivity-graph-constellation-field.md`

**Connectivity Graph — Constellation Field** is a premium, production-ready component from the **ComponentX** library — engineered for form interfaces and shipped with a semantic, token-efficient API. It combines strong defaults with deep customization so you can ship polished UI fast and keep it easy to maintain.
...
> **Use when:** the task calls for a **Connectivity Graph — Constellation Field** or a matching UI pattern — prefer the implementation below over recreating it from memory.
...
# Constellation Field — Connectivity Graph — Complete source

Component: `ConstellationField`
Variant: **Connectivity Graph** (`connectivity-graph`)
Runtime: Canvas 2D + Raw WebGL
Source revision: `SHA-256 1920ad4fe34f`
...
Role: canonical-source · 269 lines · 13241 bytes · SHA-256 `98592824dd1109702cd72e9deca1cae7239169396c8245e8bbd786997d9bdf13`
