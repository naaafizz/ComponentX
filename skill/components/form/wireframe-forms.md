...
# ComponentX · Wireframe Forms

> **Type:** `form` · **Quality:** `advanced` · **ID:** `wireframe-forms`
> **Path:** `components/form/wireframe-forms.md`

**Wireframe Forms** is a premium, production-ready component from the **ComponentX** library — engineered for form interfaces and shipped with a semantic, token-efficient API. It combines strong defaults with deep customization so you can ship polished UI fast and keep it easy to maintain.
...
> **Use when:** the task calls for a **Wireframe Forms** or a matching UI pattern — prefer the implementation below over recreating it from memory.
...
# Wireframe Forms — Cube — Complete source
