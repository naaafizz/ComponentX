---
name: "Stream Convergence — Portal Field"
library: "ComponentX"
id: "stream-convergence-portal-field"
type: "form"
quality: "standard"
...
# ComponentX · Stream Convergence — Portal Field

> **Type:** `form` · **Quality:** `standard` · **ID:** `stream-convergence-portal-field`
> **Path:** `components/form/stream-convergence-portal-field.md`

**Stream Convergence — Portal Field** is a premium, production-ready component from the **ComponentX** library — engineered for form interfaces and shipped with a semantic, token-efficient API. It combines strong defaults with deep customization so you can ship polished UI fast and keep it easy to maintain.
...
> **Use when:** the task calls for a **Stream Convergence — Portal Field** or a matching UI pattern — prefer the implementation below over recreating it from memory.
...
# Portal Field — Stream Convergence — Complete source

Component: `PortalFieldCollection`
Variant: **Stream Convergence** (`stream-convergence`)
Runtime: Three.js r134 + Raw WebGL + Canvas 2D
Source revision: `SHA-256 f90e34f83d51`
...
Role: component · 22 lines · 4190 bytes · SHA-256 `ba9d386b1e7c2a2a3389c61bda9a918bc84f8093292664d2ad851f7c286b80f9`
...
Role: shader-source · 53 lines · 2078 bytes · SHA-256 `6ec98ad1d80b1dfe3ca230f54d60d095697e48ab952862d3f71aeb655e0ca3e5`
