---
name: "Interface Craft Cards"
library: "ComponentX"
id: "interface-craft-cards"
type: "card"
quality: "advanced"
tags: ["button", "card", "text"]
load_policy: "Load only after this component is selected from CATALOG.md."
---

# ComponentX · Interface Craft Cards

> **Type:** `card` · **Quality:** `advanced` · **ID:** `interface-craft-cards`
> **Path:** `components/card/interface-craft-cards.md`

**Interface Craft Cards** is a premium, production-ready component from the **ComponentX** library — engineered for card interfaces and shipped with a semantic, token-efficient API. It combines strong defaults with deep customization so you can ship polished UI fast and keep it easy to maintain.
...
- **Pattern coverage** — includes `button`, `card`, `text` workflows.
- **Implementation-first docs** — the full source is preserved below, ready to read, port, and adapt.

> **Use when:** the task calls for a **Interface Craft Cards** or a matching UI pattern — prefer the implementation below over recreating it from memory.
