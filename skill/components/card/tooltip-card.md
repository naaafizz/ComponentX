...
# ComponentX · Tooltip Card

> **Type:** `card` · **Quality:** `advanced` · **ID:** `tooltip-card`
> **Path:** `components/card/tooltip-card.md`

**Tooltip Card** is a premium, production-ready component from the **ComponentX** library — engineered for card interfaces and shipped with a semantic, token-efficient API. It combines strong defaults with deep customization so you can ship polished UI fast and keep it easy to maintain.
...
> **Use when:** the task calls for a **Tooltip Card** or a matching UI pattern — prefer the implementation below over recreating it from memory.
...
const TooltipCard = () => {
  return (
    <div>
      <img
        src="https://assets.ComponentX.com/screenshots/tyler.webp"
        alt="Tyler Durden"
