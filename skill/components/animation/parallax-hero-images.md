...
type: "animation"
quality: "showcase"
tags: ["3d", "animation", "loading", "text"]
load_policy: "Load only after this component is selected from CATALOG.md."
---

# ComponentX · Parallax Hero Images

> **Type:** `animation` · **Quality:** `showcase` · **ID:** `parallax-hero-images`
> **Path:** `components/animation/parallax-hero-images.md`

**Parallax Hero Images** is a premium, production-ready component from the **ComponentX** library — engineered for animation interfaces and shipped with a semantic, token-efficient API. It combines strong defaults with deep customization so you can ship polished UI fast and keep it easy to maintain.
...
- **Pattern coverage** — includes `3d`, `animation`, `loading` workflows.
- **Pattern coverage** — includes `text` workflows.
- **Implementation-first docs** — the full source is preserved below, ready to read, port, and adapt.

> **Use when:** the task calls for a **Parallax Hero Images** or a matching UI pattern — prefer the implementation below over recreating it from memory.
...
const images = [
  "https://assets.ComponentX.com/components/hero-section-with-mesh-gradient.webp",
  "https://assets.ComponentX.com/components/3d-globe.webp",
  "https://assets.ComponentX.com/components/keyboard-2.webp",
  "https://assets.ComponentX.com/components/hero-1.webp",
  "https://assets.ComponentX.com/components/hero-2.webp",
  "https://assets.ComponentX.com/components/hero-3.webp",
];
