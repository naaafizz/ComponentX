---
name: "Particle Wordmark — Article Headings"
library: "ComponentX"
id: "particle-wordmark-article-headings"
type: "text"
quality: "showcase"
...
# ComponentX · Particle Wordmark — Article Headings

> **Type:** `text` · **Quality:** `showcase` · **ID:** `particle-wordmark-article-headings`
> **Path:** `components/text/particle-wordmark-article-headings.md`

**Particle Wordmark — Article Headings** is a premium, production-ready component from the **ComponentX** library — engineered for text interfaces and shipped with a semantic, token-efficient API. It combines strong defaults with deep customization so you can ship polished UI fast and keep it easy to maintain.
...
> **Use when:** the task calls for a **Particle Wordmark — Article Headings** or a matching UI pattern — prefer the implementation below over recreating it from memory.
...
# Article Headings — Particle Wordmark — Complete source

Component: `TextAnimationCollection`
Variant: **Particle Wordmark** (`particle-wordmark`)
Runtime: DOM/CSS + Canvas 2D
Source revision: `5a736cd3c1f6f19802f61ebb10e1701b9f7aa26e / SHA-256 e14795f24ea8 / 8d2cfccf1140 / 26f0d8d04494 / 1545c354af8d`
...
Role: canonical-source · 444 lines · 15643 bytes · SHA-256 `8d2cfccf114001daf5507ec759fa78b23ddb7177f934a7398560d75f5def1974`
