---
name: "Halftone Loop — Gallery Heading"
library: "ComponentX"
id: "halftone-loop-gallery-heading"
type: "media"
quality: "advanced"
...
# ComponentX · Halftone Loop — Gallery Heading

> **Type:** `media` · **Quality:** `advanced` · **ID:** `halftone-loop-gallery-heading`
> **Path:** `components/media/halftone-loop-gallery-heading.md`

**Halftone Loop — Gallery Heading** is a premium, production-ready component from the **ComponentX** library — engineered for media interfaces and shipped with a semantic, token-efficient API. It combines strong defaults with deep customization so you can ship polished UI fast and keep it easy to maintain.
...
> **Use when:** the task calls for a **Halftone Loop — Gallery Heading** or a matching UI pattern — prefer the implementation below over recreating it from memory.
...
# Gallery Heading — Halftone Loop — Complete source
