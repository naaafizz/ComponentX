...
# ComponentX · Range Calendar

> **Type:** `data-display` · **Quality:** `advanced` · **ID:** `range-calendar`
> **Path:** `components/data-display/range-calendar.md`

**Range Calendar** is a premium, production-ready component from the **ComponentX** library — engineered for data display interfaces and shipped with a semantic, token-efficient API. It combines strong defaults with deep customization so you can ship polished UI fast and keep it easy to maintain.
...
> **Use when:** the task calls for a **Range Calendar** or a matching UI pattern — prefer the implementation below over recreating it from memory.
...
import {
  ...
  RangeCalendarCell
} from "@/components/componentx/core/range-calendar";
...
>
  <RangeCalendarDefaultValuePreview />
</ComponentPreview>
...
>
  <RangeCalendarControlledPreview />
</ComponentPreview>
...
>
  <RangeCalendarDisabledCellPreview />
</ComponentPreview>
...
>
  <RangeCalendarUnavailablePreview />
</ComponentPreview>
...
>
  <RangeCalendarAllowsNonContiguousPreview />
</ComponentPreview>
...
>
  <RangeCalendarValidationPreview />
</ComponentPreview>
...
>
  <RangeCalendarYearPickerPreview />
</ComponentPreview>
...
>
  <RangeCalendarMultipleMonthsPreview />
</ComponentPreview>
...
>
  <RangeCalendarInternationalizedPreview />
</ComponentPreview>
...
The header wrapper used for navigation and month/year controls. This is a ComponentX registry wrapper around a native `<header>` element, not a React Aria component.
...
An in-header year picker driven by `RangeCalendarStateContext`. This is a ComponentX-specific control and is not part of React Aria's public API.
