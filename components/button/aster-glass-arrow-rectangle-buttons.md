---
name: "Aster Glass Arrow — Rectangle Buttons"
library: "ComponentX"
id: "aster-glass-arrow-rectangle-buttons"
type: "button"
quality: "lightweight"
...
# ComponentX · Aster Glass Arrow — Rectangle Buttons

> **Type:** `button` · **Quality:** `lightweight` · **ID:** `aster-glass-arrow-rectangle-buttons`
> **Path:** `components/button/aster-glass-arrow-rectangle-buttons.md`

**Aster Glass Arrow — Rectangle Buttons** is a premium, production-ready component from the **ComponentX** library — engineered for button interfaces and shipped with a semantic, token-efficient API. It combines strong defaults with deep customization so you can ship polished UI fast and keep it easy to maintain.
...
> **Use when:** the task calls for a **Aster Glass Arrow — Rectangle Buttons** or a matching UI pattern — prefer the implementation below over recreating it from memory.
...
# Rectangle Buttons — Aster Glass Arrow — Complete source

Component: `RectangleButtons`
Variant: **Aster Glass Arrow** (`aster-glass-arrow`)
Runtime: DOM + CSS
Source revision: `SHA-256 ff30e28c2781`
