---
name: "Ember Keycap — Rectangle Buttons"
library: "ComponentX"
...
# ComponentX · Ember Keycap — Rectangle Buttons

> **Type:** `button` · **Quality:** `lightweight` · **ID:** `ember-keycap-rectangle-buttons`
> **Path:** `components/button/ember-keycap-rectangle-buttons.md`

**Ember Keycap — Rectangle Buttons** is a premium, production-ready component from the **ComponentX** library — engineered for button interfaces and shipped with a semantic, token-efficient API. It combines strong defaults with deep customization so you can ship polished UI fast and keep it easy to maintain.
...
> **Use when:** the task calls for a **Ember Keycap — Rectangle Buttons** or a matching UI pattern — prefer the implementation below over recreating it from memory.
