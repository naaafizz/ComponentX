---
name: "Meridian Keycap Primary — Rectangle Buttons"
library: "ComponentX"
...
# ComponentX · Meridian Keycap Primary — Rectangle Buttons

> **Type:** `button` · **Quality:** `lightweight` · **ID:** `meridian-keycap-primary-rectangle-buttons`
> **Path:** `components/button/meridian-keycap-primary-rectangle-buttons.md`

**Meridian Keycap Primary — Rectangle Buttons** is a premium, production-ready component from the **ComponentX** library — engineered for button interfaces and shipped with a semantic, token-efficient API. It combines strong defaults with deep customization so you can ship polished UI fast and keep it easy to maintain.
...
> **Use when:** the task calls for a **Meridian Keycap Primary — Rectangle Buttons** or a matching UI pattern — prefer the implementation below over recreating it from memory.
...
# Rectangle Buttons — Meridian Keycap Primary — Complete source

Component: `RectangleButtons`
Variant: **Meridian Keycap Primary** (`meridian-keycap-primary`)
Runtime: DOM + CSS
Source revision: `SHA-256 ff30e28c2781`
