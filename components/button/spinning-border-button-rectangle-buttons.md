---
name: "Spinning Border Button — Rectangle Buttons"
library: "ComponentX"
id: "spinning-border-button-rectangle-buttons"
type: "button"
quality: "showcase"
tags: ["animated", "animation", "background", "button", "layout", "shader", "text", "webgl"]
load_policy: "Load only after this component is selected from CATALOG.md."
---

# ComponentX · Spinning Border Button — Rectangle Buttons

> **Type:** `button` · **Quality:** `showcase` · **ID:** `spinning-border-button-rectangle-buttons`
> **Path:** `components/button/spinning-border-button-rectangle-buttons.md`

**Spinning Border Button — Rectangle Buttons** is a premium, production-ready component from the **ComponentX** library — engineered for button interfaces and shipped with a semantic, token-efficient API. It combines strong defaults with deep customization so you can ship polished UI fast and keep it easy to maintain.
...
- **Pattern coverage** — includes `button`, `layout`, `shader` workflows.
- **Pattern coverage** — includes `text`, `webgl` workflows.
- **Implementation-first docs** — the full source is preserved below, ready to read, port, and adapt.

> **Use when:** the task calls for a **Spinning Border Button — Rectangle Buttons** or a matching UI pattern — prefer the implementation below over recreating it from memory.
...
# Rectangle Buttons — Sliding Text CTA — Complete source

Component: `RectangleButtons`
Variant: **Sliding Text CTA** (`sliding-text-cta`)
Runtime: DOM + CSS
Source revision: `SHA-256 ff30e28c2781`
...
Role: canonical-source · 132 lines · 5846 bytes · SHA-256 `e24ce6a519cfbafe082deb6eedb801b97b36ba6b8ccea9a81166c9b6edb6e770`
