---
name: "Floating Dots CTA — Rectangle Buttons"
library: "ComponentX"
id: "floating-dots-cta-rectangle-buttons"
type: "button"
quality: "lightweight"
...
# ComponentX · Floating Dots CTA — Rectangle Buttons

> **Type:** `button` · **Quality:** `lightweight` · **ID:** `floating-dots-cta-rectangle-buttons`
> **Path:** `components/button/floating-dots-cta-rectangle-buttons.md`

**Floating Dots CTA — Rectangle Buttons** is a premium, production-ready component from the **ComponentX** library — engineered for button interfaces and shipped with a semantic, token-efficient API. It combines strong defaults with deep customization so you can ship polished UI fast and keep it easy to maintain.
...
> **Use when:** the task calls for a **Floating Dots CTA — Rectangle Buttons** or a matching UI pattern — prefer the implementation below over recreating it from memory.
...
# Rectangle Buttons — Floating Dots CTA — Complete source

Component: `RectangleButtons`
Variant: **Floating Dots CTA** (`floating-dots-cta`)
Runtime: DOM + CSS
Source revision: `SHA-256 ff30e28c2781`
...
Role: canonical-source · 342 lines · 9054 bytes · SHA-256 `28f53a8d14920bbfede14b0cf096ebddef5dfbee87d46cfc70bdfb612c5796da`
