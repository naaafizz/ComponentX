---
name: "Iridescent Silk — Woven Cloth"
library: "ComponentX"
id: "iridescent-silk-woven-cloth"
type: "button"
quality: "showcase"
...
# ComponentX · Iridescent Silk — Woven Cloth

> **Type:** `button` · **Quality:** `showcase` · **ID:** `iridescent-silk-woven-cloth`
> **Path:** `components/button/iridescent-silk-woven-cloth.md`

**Iridescent Silk — Woven Cloth** is a premium, production-ready component from the **ComponentX** library — engineered for button interfaces and shipped with a semantic, token-efficient API. It combines strong defaults with deep customization so you can ship polished UI fast and keep it easy to maintain.
...
> **Use when:** the task calls for a **Iridescent Silk — Woven Cloth** or a matching UI pattern — prefer the implementation below over recreating it from memory.
...
# Woven Cloth — Iridescent Silk — Complete source

Component: `WovenCloth`
Variant: **Iridescent Silk** (`iridescent`)
Runtime: Three.js r160
Source revision: `SHA-256 9bfd56ef7579`
