...
type: "button"
quality: "standard"
tags: ["button", "component", "form", "layout", "menu", "navigation", "overlay", "text"]
load_policy: "Load only after this component is selected from CATALOG.md."
---

# ComponentX · Sheet

> **Type:** `button` · **Quality:** `standard` · **ID:** `sheet`
> **Path:** `components/button/sheet.md`

**Sheet** is a premium, production-ready component from the **ComponentX** library — engineered for button interfaces and shipped with a semantic, token-efficient API. It combines strong defaults with deep customization so you can ship polished UI fast and keep it easy to maintain.
...
- **Pattern coverage** — includes `button`, `form`, `layout` workflows.
- **Pattern coverage** — includes `menu`, `navigation`, `overlay` workflows.
- **Pattern coverage** — includes `text` workflows.
- **Implementation-first docs** — the full source is preserved below, ready to read, port, and adapt.

> **Use when:** the task calls for a **Sheet** or a matching UI pattern — prefer the implementation below over recreating it from memory.
...
import {
  ...
  SheetFooter,
  SheetClose
} from "@/components/componentx/core/sheet";
