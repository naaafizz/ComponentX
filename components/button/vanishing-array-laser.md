...
# ComponentX · Vanishing Array — Laser

> **Type:** `button` · **Quality:** `showcase` · **ID:** `vanishing-array-laser`
> **Path:** `components/button/vanishing-array-laser.md`

**Vanishing Array — Laser** is a premium, production-ready component from the **ComponentX** library — engineered for button interfaces and shipped with a semantic, token-efficient API. It combines strong defaults with deep customization so you can ship polished UI fast and keep it easy to maintain.
...
> **Use when:** the task calls for a **Vanishing Array — Laser** or a matching UI pattern — prefer the implementation below over recreating it from memory.
...
---
name: add-matrix-field
description: "Build Laser from its verified authored source using Raw WebGL, including the complete renderer, interactions, and required assets. Use when Codex needs to implement, port, or adapt this effect without requiring the ComponentX package or reconstructing the visual from an approximation."
---
...
Four pointer-reactive laser scenes spanning a preserved matrix junction, atmospheric blade, vanishing array, and halftone relay.
...
- Raw WebGL copied from the byte-exact Neuform export
...
3. After the source load event, retain only the #glcanvas surface; do not rewrite the renderer or approximate the composition.
...
```tsx
import { LaserCollection } from "./effects/matrix-field/LaserCollection";
import "./effects/matrix-field/styles.css";

export function Scene() {
  return <div className="effect-frame"><LaserCollection /></div>;
}
```
...
- **renderer** (host): Raw WebGL + preserved sandboxed WebGL
- **variants** (fixed): Matrix Junction + Atmospheric Blade + Vanishing Array + Halftone Relay
- **interaction** (pointer): Smoothed horizontal and vertical response
- **pixelRatio** (adaptive): Capped at 1.5
- **motion** (adaptive): Visibility-aware + reduced-motion still
- **assets** (fixed): No external assets
...
# Laser — Vanishing Array — Complete source

Component: `LaserCollection`
Variant: **Vanishing Array** (`vanishing-array`)
Runtime: Raw WebGL
Source revision: `SHA-256 70cc015d5175`
...
```tsx
import { LaserCollection } from "@componentx/threeui";
...
Role: component · 38 lines · 1194 bytes · SHA-256 `e81830f73d86cbaa71e4f32568ec596c461500370ef971315b1dff682c9d1639`
...
Role: variant-component · 250 lines · 8797 bytes · SHA-256 `4fdc907769b67369de011ee96594aed6dd0f54974c1db831ac9ac5c5f371ba4a`
...
Role: shader-source · 218 lines · 8654 bytes · SHA-256 `91248e937612f2d11b8dde4716d3546e47cd192ad36ebc76e1860f728285f967`
...
Role: canonical-source · 372 lines · 21070 bytes · SHA-256 `7ee84b44ccad91f131563f34c633596a4c105512e8f0aa4303736f77681db835`
