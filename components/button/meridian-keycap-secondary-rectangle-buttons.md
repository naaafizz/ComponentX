---
name: "Meridian Keycap Secondary — Rectangle Buttons"
library: "ComponentX"
...
# ComponentX · Meridian Keycap Secondary — Rectangle Buttons

> **Type:** `button` · **Quality:** `lightweight` · **ID:** `meridian-keycap-secondary-rectangle-buttons`
> **Path:** `components/button/meridian-keycap-secondary-rectangle-buttons.md`

**Meridian Keycap Secondary — Rectangle Buttons** is a premium, production-ready component from the **ComponentX** library — engineered for button interfaces and shipped with a semantic, token-efficient API. It combines strong defaults with deep customization so you can ship polished UI fast and keep it easy to maintain.
...
> **Use when:** the task calls for a **Meridian Keycap Secondary — Rectangle Buttons** or a matching UI pattern — prefer the implementation below over recreating it from memory.
...
# Rectangle Buttons — Meridian Keycap Secondary — Complete source

Component: `RectangleButtons`
Variant: **Meridian Keycap Secondary** (`meridian-keycap-secondary`)
Runtime: DOM + CSS
Source revision: `SHA-256 ff30e28c2781`
