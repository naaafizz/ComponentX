---
name: "Lumen CTA Ghost — Rectangle Buttons"
library: "ComponentX"
id: "lumen-cta-ghost-rectangle-buttons"
type: "button"
quality: "lightweight"
...
# ComponentX · Lumen CTA Ghost — Rectangle Buttons

> **Type:** `button` · **Quality:** `lightweight` · **ID:** `lumen-cta-ghost-rectangle-buttons`
> **Path:** `components/button/lumen-cta-ghost-rectangle-buttons.md`

**Lumen CTA Ghost — Rectangle Buttons** is a premium, production-ready component from the **ComponentX** library — engineered for button interfaces and shipped with a semantic, token-efficient API. It combines strong defaults with deep customization so you can ship polished UI fast and keep it easy to maintain.
...
> **Use when:** the task calls for a **Lumen CTA Ghost — Rectangle Buttons** or a matching UI pattern — prefer the implementation below over recreating it from memory.
...
# Rectangle Buttons — Lumen CTA Ghost — Complete source

Component: `RectangleButtons`
Variant: **Lumen CTA Ghost** (`lumen-cta-ghost`)
Runtime: DOM + CSS
Source revision: `SHA-256 ff30e28c2781`
