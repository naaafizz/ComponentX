---
name: "Tideform Outline — Rectangle Buttons"
library: "ComponentX"
...
# ComponentX · Tideform Outline — Rectangle Buttons

> **Type:** `button` · **Quality:** `advanced` · **ID:** `tideform-outline-rectangle-buttons`
> **Path:** `components/button/tideform-outline-rectangle-buttons.md`

**Tideform Outline — Rectangle Buttons** is a premium, production-ready component from the **ComponentX** library — engineered for button interfaces and shipped with a semantic, token-efficient API. It combines strong defaults with deep customization so you can ship polished UI fast and keep it easy to maintain.
...
> **Use when:** the task calls for a **Tideform Outline — Rectangle Buttons** or a matching UI pattern — prefer the implementation below over recreating it from memory.
...
# Rectangle Buttons — Ember Keycap — Complete source

Component: `RectangleButtons`
Variant: **Ember Keycap** (`ember-keycap`)
Runtime: DOM + CSS
Source revision: `SHA-256 ff30e28c2781`
