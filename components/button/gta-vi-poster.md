...
# ComponentX · GTA VI Poster

> **Type:** `button` · **Quality:** `standard` · **ID:** `gta-vi-poster`
> **Path:** `components/button/gta-vi-poster.md`

**GTA VI Poster** is a premium, production-ready component from the **ComponentX** library — engineered for button interfaces and shipped with a semantic, token-efficient API. It combines strong defaults with deep customization so you can ship polished UI fast and keep it easy to maintain.
...
> **Use when:** the task calls for a **GTA VI Poster** or a matching UI pattern — prefer the implementation below over recreating it from memory.
...
const ASSET_BASE_URL = "https://assets.ComponentX.com/gta6";
