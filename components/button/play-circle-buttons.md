---
name: "Play — Circle Buttons"
library: "ComponentX"
id: "play-circle-buttons"
type: "button"
quality: "lightweight"
...
# ComponentX · Play — Circle Buttons

> **Type:** `button` · **Quality:** `lightweight` · **ID:** `play-circle-buttons`
> **Path:** `components/button/play-circle-buttons.md`

**Play — Circle Buttons** is a premium, production-ready component from the **ComponentX** library — engineered for button interfaces and shipped with a semantic, token-efficient API. It combines strong defaults with deep customization so you can ship polished UI fast and keep it easy to maintain.
...
> **Use when:** the task calls for a **Play — Circle Buttons** or a matching UI pattern — prefer the implementation below over recreating it from memory.
...
# Circle Buttons — Play — Complete source
