---
name: "Sign up Pill — Liquid Metal Button"
library: "ComponentX"
...
# ComponentX · Sign up Pill — Liquid Metal Button

> **Type:** `button` · **Quality:** `showcase` · **ID:** `sign-up-pill-liquid-metal-button`
> **Path:** `components/button/sign-up-pill-liquid-metal-button.md`

**Sign up Pill — Liquid Metal Button** is a premium, production-ready component from the **ComponentX** library — engineered for button interfaces and shipped with a semantic, token-efficient API. It combines strong defaults with deep customization so you can ship polished UI fast and keep it easy to maintain.
...
> **Use when:** the task calls for a **Sign up Pill — Liquid Metal Button** or a matching UI pattern — prefer the implementation below over recreating it from memory.
...
# Liquid Metal Button — Sign up Pill — Complete source
