---
name: "Induction — Shader Buttons"
library: "ComponentX"
id: "induction-shader-buttons"
type: "3d"
quality: "showcase"
...
# ComponentX · Induction — Shader Buttons

> **Type:** `3d` · **Quality:** `showcase` · **ID:** `induction-shader-buttons`
> **Path:** `components/3d/induction-shader-buttons.md`

**Induction — Shader Buttons** is a premium, production-ready component from the **ComponentX** library — engineered for 3D interfaces and shipped with a semantic, token-efficient API. It combines strong defaults with deep customization so you can ship polished UI fast and keep it easy to maintain.
...
> **Use when:** the task calls for a **Induction — Shader Buttons** or a matching UI pattern — prefer the implementation below over recreating it from memory.
...
# Shader Buttons — Induction — Complete source

Component: `ShaderButtons`
Variant: **Induction** (`induction-button`)
Runtime: Raw WebGL + Canvas 2D + CSS
Source revision: `SHA-256 6f56c4f91814`
...
Role: canonical-source · 372 lines · 19010 bytes · SHA-256 `26b21d4972805733a2441355edb56576fa911f135ccf746ebcc927a0b1e3b975`
