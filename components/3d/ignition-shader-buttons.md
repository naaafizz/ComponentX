---
name: "Ignition — Shader Buttons"
library: "ComponentX"
id: "ignition-shader-buttons"
type: "3d"
quality: "showcase"
...
# ComponentX · Ignition — Shader Buttons

> **Type:** `3d` · **Quality:** `showcase` · **ID:** `ignition-shader-buttons`
> **Path:** `components/3d/ignition-shader-buttons.md`

**Ignition — Shader Buttons** is a premium, production-ready component from the **ComponentX** library — engineered for 3D interfaces and shipped with a semantic, token-efficient API. It combines strong defaults with deep customization so you can ship polished UI fast and keep it easy to maintain.
...
> **Use when:** the task calls for a **Ignition — Shader Buttons** or a matching UI pattern — prefer the implementation below over recreating it from memory.
...
# Shader Buttons — Ignition — Complete source
...
Role: canonical-source · 319 lines · 12813 bytes · SHA-256 `05313d191cc11ca0c7600452e72ad14b4fc6581627689c209a5f22a1bfa6a8ea`
