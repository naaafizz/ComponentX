---
name: "Shader — Skeuomorphic Toggle"
library: "ComponentX"
id: "shader-skeuomorphic-toggle"
type: "3d"
quality: "showcase"
...
# ComponentX · Shader — Skeuomorphic Toggle

> **Type:** `3d` · **Quality:** `showcase` · **ID:** `shader-skeuomorphic-toggle`
> **Path:** `components/3d/shader-skeuomorphic-toggle.md`

**Shader — Skeuomorphic Toggle** is a premium, production-ready component from the **ComponentX** library — engineered for 3D interfaces and shipped with a semantic, token-efficient API. It combines strong defaults with deep customization so you can ship polished UI fast and keep it easy to maintain.
...
> **Use when:** the task calls for a **Shader — Skeuomorphic Toggle** or a matching UI pattern — prefer the implementation below over recreating it from memory.
...
# Skeuomorphic Toggle — Shader — Complete source
