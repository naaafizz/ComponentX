---
name: "Plasma — Shader Buttons"
library: "ComponentX"
id: "plasma-shader-buttons"
type: "3d"
quality: "showcase"
...
# ComponentX · Plasma — Shader Buttons

> **Type:** `3d` · **Quality:** `showcase` · **ID:** `plasma-shader-buttons`
> **Path:** `components/3d/plasma-shader-buttons.md`

**Plasma — Shader Buttons** is a premium, production-ready component from the **ComponentX** library — engineered for 3D interfaces and shipped with a semantic, token-efficient API. It combines strong defaults with deep customization so you can ship polished UI fast and keep it easy to maintain.
...
> **Use when:** the task calls for a **Plasma — Shader Buttons** or a matching UI pattern — prefer the implementation below over recreating it from memory.
...
# Shader Buttons — Plasma — Complete source

Component: `ShaderButtons`
Variant: **Plasma** (`plasma-button`)
Runtime: Raw WebGL + Canvas 2D + CSS
Source revision: `SHA-256 6f56c4f91814`
...
Role: canonical-source · 335 lines · 15926 bytes · SHA-256 `eea617fe0e37a79be7aee44f00a53ec3ae41e006e771a8aad53acce3648147e0`
