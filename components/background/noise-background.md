...
type: "background"
quality: "standard"
tags: ["animation", "background", "button", "overlay", "text"]
load_policy: "Load only after this component is selected from CATALOG.md."
---

# ComponentX · Noise Background

> **Type:** `background` · **Quality:** `standard` · **ID:** `noise-background`
> **Path:** `components/background/noise-background.md`

**Noise Background** is a premium, production-ready component from the **ComponentX** library — engineered for background interfaces and shipped with a semantic, token-efficient API. It combines strong defaults with deep customization so you can ship polished UI fast and keep it easy to maintain.
...
> **Use when:** the task calls for a **Noise Background** or a matching UI pattern — prefer the implementation below over recreating it from memory.
...
File location: components/noise-background-demo.tsx

File content: import { NoiseBackground } from "@/components/ui/noise-background";
...
File location: components/ui/noise-background.tsx
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <img
          src="https://assets.ComponentX.com/noise.webp"
          alt=""
