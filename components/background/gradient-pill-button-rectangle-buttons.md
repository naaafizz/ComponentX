---
name: "Gradient Pill Button — Rectangle Buttons"
library: "ComponentX"
id: "gradient-pill-button-rectangle-buttons"
type: "background"
quality: "lightweight"
...
# ComponentX · Gradient Pill Button — Rectangle Buttons

> **Type:** `background` · **Quality:** `lightweight` · **ID:** `gradient-pill-button-rectangle-buttons`
> **Path:** `components/background/gradient-pill-button-rectangle-buttons.md`

**Gradient Pill Button — Rectangle Buttons** is a premium, production-ready component from the **ComponentX** library — engineered for background interfaces and shipped with a semantic, token-efficient API. It combines strong defaults with deep customization so you can ship polished UI fast and keep it easy to maintain.
...
> **Use when:** the task calls for a **Gradient Pill Button — Rectangle Buttons** or a matching UI pattern — prefer the implementation below over recreating it from memory.
