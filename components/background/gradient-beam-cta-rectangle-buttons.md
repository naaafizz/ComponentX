---
name: "Gradient Beam CTA — Rectangle Buttons"
library: "ComponentX"
...
# ComponentX · Gradient Beam CTA — Rectangle Buttons

> **Type:** `background` · **Quality:** `lightweight` · **ID:** `gradient-beam-cta-rectangle-buttons`
> **Path:** `components/background/gradient-beam-cta-rectangle-buttons.md`

**Gradient Beam CTA — Rectangle Buttons** is a premium, production-ready component from the **ComponentX** library — engineered for background interfaces and shipped with a semantic, token-efficient API. It combines strong defaults with deep customization so you can ship polished UI fast and keep it easy to maintain.
...
> **Use when:** the task calls for a **Gradient Beam CTA — Rectangle Buttons** or a matching UI pattern — prefer the implementation below over recreating it from memory.
