...
type: "overlay"
quality: "standard"
tags: ["button", "menu", "navigation", "overlay", "text"]
load_policy: "Load only after this component is selected from CATALOG.md."
---

# ComponentX · Dropdown

> **Type:** `overlay` · **Quality:** `standard` · **ID:** `dropdown`
> **Path:** `components/overlay/dropdown.md`
...
} from "@/components/componentx/core/dropdown";
