...
type: "overlay"
quality: "standard"
tags: ["button", "layout", "overlay", "text"]
load_policy: "Load only after this component is selected from CATALOG.md."
---

# ComponentX · Drawer

> **Type:** `overlay` · **Quality:** `standard` · **ID:** `drawer`
> **Path:** `components/overlay/drawer.md`

**Drawer** is a premium, production-ready component from the **ComponentX** library — engineered for overlay interfaces and shipped with a semantic, token-efficient API. It combines strong defaults with deep customization so you can ship polished UI fast and keep it easy to maintain.
...
- **Pattern coverage** — includes `button`, `layout`, `overlay` workflows.
- **Pattern coverage** — includes `text` workflows.
- **Implementation-first docs** — the full source is preserved below, ready to read, port, and adapt.

> **Use when:** the task calls for a **Drawer** or a matching UI pattern — prefer the implementation below over recreating it from memory.
...
Built with React Aria, ComponentX Motion, and Tailwind CSS, it supports smooth animations, accessibility, and works well across different screen sizes.
...
import {
  ...
  DrawerFooter,
  DrawerClose
} from "@/components/componentx/core/drawer";
