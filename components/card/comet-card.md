...
type: "card"
quality: "showcase"
tags: ["3d", "background", "button", "card", "loading", "overlay", "text"]
load_policy: "Load only after this component is selected from CATALOG.md."
---

# ComponentX · Comet Card

> **Type:** `card` · **Quality:** `showcase` · **ID:** `comet-card`
> **Path:** `components/card/comet-card.md`

**Comet Card** is a premium, production-ready component from the **ComponentX** library — engineered for card interfaces and shipped with a semantic, token-efficient API. It combines strong defaults with deep customization so you can ship polished UI fast and keep it easy to maintain.
...
- **Pattern coverage** — includes `3d`, `background`, `button` workflows.
- **Pattern coverage** — includes `card`, `loading`, `overlay` workflows.
- **Pattern coverage** — includes `text` workflows.
- **Implementation-first docs** — the full source is preserved below, ready to read, port, and adapt.

> **Use when:** the task calls for a **Comet Card** or a matching UI pattern — prefer the implementation below over recreating it from memory.
