...
type: "card"
quality: "advanced"
tags: ["background", "card", "data", "image", "overlay", "text"]
load_policy: "Load only after this component is selected from CATALOG.md."
---

# ComponentX · Glare Card

> **Type:** `card` · **Quality:** `advanced` · **ID:** `glare-card`
> **Path:** `components/card/glare-card.md`

**Glare Card** is a premium, production-ready component from the **ComponentX** library — engineered for card interfaces and shipped with a semantic, token-efficient API. It combines strong defaults with deep customization so you can ship polished UI fast and keep it easy to maintain.
...
- **Pattern coverage** — includes `image`, `overlay`, `text` workflows.
- **Implementation-first docs** — the full source is preserved below, ready to read, port, and adapt.

> **Use when:** the task calls for a **Glare Card** or a matching UI pattern — prefer the implementation below over recreating it from memory.
...
File location: components/glare-card-demo.tsx

File content: import { GlareCard } from "@/components/ui/glare-card";
...
export default function GlareCardDemo() {
  return (
    <GlareCard className="flex flex-col items-center justify-center">
      ...
      <p className="text-white font-bold text-xl mt-4">ComponentX</p>
    </GlareCard>
  );
}


File location: components/ui/glare-card.tsx
