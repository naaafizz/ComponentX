...
type: "card"
quality: "advanced"
tags: ["button", "card", "form", "image", "layout", "text"]
load_policy: "Load only after this component is selected from CATALOG.md."
---

# ComponentX · Card

> **Type:** `card` · **Quality:** `advanced` · **ID:** `card`
> **Path:** `components/card/card.md`

**Card** is a premium, production-ready component from the **ComponentX** library — engineered for card interfaces and shipped with a semantic, token-efficient API. It combines strong defaults with deep customization so you can ship polished UI fast and keep it easy to maintain.
...
- **Pattern coverage** — includes `button`, `card`, `form` workflows.
- **Pattern coverage** — includes `image`, `layout`, `text` workflows.
- **Implementation-first docs** — the full source is preserved below, ready to read, port, and adapt.

> **Use when:** the task calls for a **Card** or a matching UI pattern — prefer the implementation below over recreating it from memory.
...
import {
  ...
  CardHeader,
  CardTitle
} from "@/components/componentx/core/card";
