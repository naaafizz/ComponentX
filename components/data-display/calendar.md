...
> **Type:** `data-display` · **Quality:** `advanced` · **ID:** `calendar`
> **Path:** `components/data-display/calendar.md`
...
import {
  ...
  CalendarGridBody,
  CalendarCell
} from "@/components/componentx/core/calendar";
...
>
  <CalendarMinMaxUnavailablePreview />
</ComponentPreview>
...
>
  <CalendarInternationalizedPreview />
</ComponentPreview>
...
An in-header year picker driven by `CalendarStateContext`. This is a ComponentX-specific control and is not part of React Aria’s public `Calendar` API.
