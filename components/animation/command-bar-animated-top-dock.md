---
name: "Command Bar — Animated Top Dock"
library: "ComponentX"
id: "command-bar-animated-top-dock"
type: "animation"
quality: "showcase"
...
# ComponentX · Command Bar — Animated Top Dock

> **Type:** `animation` · **Quality:** `showcase` · **ID:** `command-bar-animated-top-dock`
> **Path:** `components/animation/command-bar-animated-top-dock.md`

**Command Bar — Animated Top Dock** is a premium, production-ready component from the **ComponentX** library — engineered for animation interfaces and shipped with a semantic, token-efficient API. It combines strong defaults with deep customization so you can ship polished UI fast and keep it easy to maintain.
...
> **Use when:** the task calls for a **Command Bar — Animated Top Dock** or a matching UI pattern — prefer the implementation below over recreating it from memory.
...
# Animated Top Dock — Command Bar — Complete source

Component: `AnimatedTopDock`
Variant: **Command Bar** (`modern`)
Runtime: DOM + CSS + WebGL + Three.js r128
Source revision: `5a736cd3c1f6f19802f61ebb10e1701b9f7aa26e`
