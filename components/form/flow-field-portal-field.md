...
# ComponentX · Flow Field — Portal Field

> **Type:** `form` · **Quality:** `standard` · **ID:** `flow-field-portal-field`
> **Path:** `components/form/flow-field-portal-field.md`

**Flow Field — Portal Field** is a premium, production-ready component from the **ComponentX** library — engineered for form interfaces and shipped with a semantic, token-efficient API. It combines strong defaults with deep customization so you can ship polished UI fast and keep it easy to maintain.
...
> **Use when:** the task calls for a **Flow Field — Portal Field** or a matching UI pattern — prefer the implementation below over recreating it from memory.
...
# Portal Field — Flow Field — Complete source
...
Role: canonical-source · 307 lines · 10590 bytes · SHA-256 `78eaf8ce34317bb66c44b72069ff36c622987ef61d3e703e8ea5800e089eb0b2`
