...
# ComponentX · Liquid Form

> **Type:** `form` · **Quality:** `showcase` · **ID:** `liquid-form`
> **Path:** `components/form/liquid-form.md`

**Liquid Form** is a premium, production-ready component from the **ComponentX** library — engineered for form interfaces and shipped with a semantic, token-efficient API. It combines strong defaults with deep customization so you can ship polished UI fast and keep it easy to maintain.
...
> **Use when:** the task calls for a **Liquid Form** or a matching UI pattern — prefer the implementation below over recreating it from memory.
...
description: "Build Liquid Form from its verified authored source using Raw WebGL, including the complete renderer, interactions, and required assets. Use when Codex needs to implement, port, or adapt this effect without requiring the ComponentX package or reconstructing the visual from an approximation."
---
...
```tsx
import { LiquidFormBackground } from "@componentx/threeui";
...
Role: component · 84 lines · 5476 bytes · SHA-256 `95e43ab2c5312ff94e0aa4cd63902f2b994a7ed881661e279a04c30c1c36234a`
...
Role: shader-source · 137 lines · 4552 bytes · SHA-256 `5ec6722aa75a4b3e5815ae811105201668e8d88a060d4bab46b38e87f136c7ea`
