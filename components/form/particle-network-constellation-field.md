---
name: "Particle Network — Constellation Field"
library: "ComponentX"
id: "particle-network-constellation-field"
type: "form"
quality: "showcase"
...
# ComponentX · Particle Network — Constellation Field

> **Type:** `form` · **Quality:** `showcase` · **ID:** `particle-network-constellation-field`
> **Path:** `components/form/particle-network-constellation-field.md`

**Particle Network — Constellation Field** is a premium, production-ready component from the **ComponentX** library — engineered for form interfaces and shipped with a semantic, token-efficient API. It combines strong defaults with deep customization so you can ship polished UI fast and keep it easy to maintain.
...
> **Use when:** the task calls for a **Particle Network — Constellation Field** or a matching UI pattern — prefer the implementation below over recreating it from memory.
...
# Constellation Field — Particle Network — Complete source

Component: `ConstellationField`
Variant: **Particle Network** (`particle-network`)
Runtime: Canvas 2D + Raw WebGL
Source revision: `SHA-256 1920ad4fe34f`
...
Role: canonical-source · 261 lines · 13776 bytes · SHA-256 `bc7bffdc48a9019cbba937dab9d335b85f20ac8a472f10dfa3d553da439cfdb7`
