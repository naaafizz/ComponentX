...
# ComponentX · Cloud Field — Portal Field

> **Type:** `form` · **Quality:** `standard` · **ID:** `cloud-field-portal-field`
> **Path:** `components/form/cloud-field-portal-field.md`

**Cloud Field — Portal Field** is a premium, production-ready component from the **ComponentX** library — engineered for form interfaces and shipped with a semantic, token-efficient API. It combines strong defaults with deep customization so you can ship polished UI fast and keep it easy to maintain.
...
> **Use when:** the task calls for a **Cloud Field — Portal Field** or a matching UI pattern — prefer the implementation below over recreating it from memory.
...
# Portal Field — Cloud Field — Complete source

Component: `PortalFieldCollection`
Variant: **Cloud Field** (`cloud-field`)
Runtime: Three.js r134 + Raw WebGL + Canvas 2D
Source revision: `SHA-256 f90e34f83d51`
...
Role: canonical-source · 471 lines · 23819 bytes · SHA-256 `c5a8085b413d310fe1c9a2deb39bcd5d8ecf0d545a4462f576a1c9b9c49f34fc`
