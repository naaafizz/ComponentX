---
name: "EV Power — Performance Gauges"
library: "ComponentX"
id: "ev-power-performance-gauges"
type: "form"
quality: "advanced"
...
# ComponentX · EV Power — Performance Gauges

> **Type:** `form` · **Quality:** `advanced` · **ID:** `ev-power-performance-gauges`
> **Path:** `components/form/ev-power-performance-gauges.md`

**EV Power — Performance Gauges** is a premium, production-ready component from the **ComponentX** library — engineered for form interfaces and shipped with a semantic, token-efficient API. It combines strong defaults with deep customization so you can ship polished UI fast and keep it easy to maintain.
...
> **Use when:** the task calls for a **EV Power — Performance Gauges** or a matching UI pattern — prefer the implementation below over recreating it from memory.
...
# Performance Gauges — EV Power — Complete source

Component: `PerformanceGauges`
Variant: **EV Power** (`power`)
Runtime: DOM + CSS
Source revision: `SHA-256 2dc25058fc85`
