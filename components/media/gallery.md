...
type: "media"
quality: "advanced"
tags: ["animation", "image", "media", "navigation", "shader", "text", "webgl"]
load_policy: "Load only after this component is selected from CATALOG.md."
---

# ComponentX · Gallery

> **Type:** `media` · **Quality:** `advanced` · **ID:** `gallery`
> **Path:** `components/media/gallery.md`

**Gallery** is a premium, production-ready component from the **ComponentX** library — engineered for media interfaces and shipped with a semantic, token-efficient API. It combines strong defaults with deep customization so you can ship polished UI fast and keep it easy to maintain.
...
- **Pattern coverage** — includes `animation`, `image`, `media` workflows.
- **Pattern coverage** — includes `navigation`, `shader`, `text` workflows.
- **Pattern coverage** — includes `webgl` workflows.
- **Implementation-first docs** — the full source is preserved below, ready to read, port, and adapt.

> **Use when:** the task calls for a **Gallery** or a matching UI pattern — prefer the implementation below over recreating it from memory.
...
---
name: add-gallery
description: "Build Gallery from its verified authored source using Three.js r149, including the complete renderer, interactions, and required assets. Use when Codex needs to implement, port, or adapt this effect without requiring the ComponentX package or reconstructing the visual from an approximation."
---
...
```tsx
import { Gallery } from "@componentx/threeui";
...
| --- | --- | ---: | --- |
| `src/shaders/gallery/assets/gallery-1.webp` | image/webp | 85466 | `86810ac01c6e9fc4d0944f4709c0495541fbb0916ba994d36bd8cf22f1a7f06c` |
| `src/shaders/gallery/assets/gallery-2.webp` | image/webp | 185898 | `7c777c14efb761dbccbbb3e8b8ff13920231964944c2038472a2ffa4d99c395d` |
| `src/shaders/gallery/assets/gallery-3.webp` | image/webp | 275230 | `8a11b3e5ba715ffbbd881947094563baae2540b407674bd0a15891037e15bba9` |
| `src/shaders/gallery/assets/gallery-4.webp` | image/webp | 391108 | `6c09469827c02ff16e4041fc1da82efdc9e59832b59ec29cc0cbe761b0862518` |
| `src/shaders/gallery/assets/gallery-5.webp` | image/webp | 187614 | `2b1aec480447e45c5b717363def6ef96bc38443179dc6f97ea25a0f8461c07b7` |
...
Role: component · 204 lines · 6310 bytes · SHA-256 `f329f985236df2801d016dd5cd34f5cf8261cfc1757b30cdcde44bf17809acfa`
...
Role: component-style · 17 lines · 356 bytes · SHA-256 `5ad4be7aadda80339b36a7aa46d8d76a83e3d0e08fb93dde8fe3117deece33a2`

```css
.threeui-background.gallery {
  position: absolute;
  inset: 0;
  overflow: hidden;
