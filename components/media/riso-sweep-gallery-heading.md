---
name: "Riso Sweep — Gallery Heading"
library: "ComponentX"
id: "riso-sweep-gallery-heading"
type: "media"
quality: "advanced"
...
# ComponentX · Riso Sweep — Gallery Heading

> **Type:** `media` · **Quality:** `advanced` · **ID:** `riso-sweep-gallery-heading`
> **Path:** `components/media/riso-sweep-gallery-heading.md`

**Riso Sweep — Gallery Heading** is a premium, production-ready component from the **ComponentX** library — engineered for media interfaces and shipped with a semantic, token-efficient API. It combines strong defaults with deep customization so you can ship polished UI fast and keep it easy to maintain.
...
> **Use when:** the task calls for a **Riso Sweep — Gallery Heading** or a matching UI pattern — prefer the implementation below over recreating it from memory.
...
description: "Build Gallery Heading from its verified authored source using Canvas 2D, including the complete renderer, interactions, and required assets. Use when Codex needs to implement, port, or adapt this effect without requiring the ComponentX package or reconstructing the visual from an approximation."
---
...
# Gallery Heading — Riso Sweep — Complete source

Component: `GalleryHeading`
Variant: **Riso Sweep** (`horizontal-sweep`)
Runtime: Canvas 2D
Source revision: `SHA-256 8e42d2d5b497`
...
```tsx
import { GalleryHeading } from "@componentx/threeui";
...
Role: canonical-source · 520 lines · 19335 bytes · SHA-256 `8e42d2d5b4971bfc4d3c485112c3c51909e20a61b8842bc0dcd8db3ffe2d253a`
