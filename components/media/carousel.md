...
type: "media"
quality: "advanced"
tags: ["3d", "button", "loading", "media", "text"]
load_policy: "Load only after this component is selected from CATALOG.md."
---

# ComponentX · Carousel

> **Type:** `media` · **Quality:** `advanced` · **ID:** `carousel`
> **Path:** `components/media/carousel.md`
...
- **Pattern coverage** — includes `3d`, `button`, `loading` workflows.
...
File content: "use client";
import { IconArrowNarrowRight } from "@componentx/icons-react";
