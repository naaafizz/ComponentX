...
# ComponentX · Gallery Heading

> **Type:** `media` · **Quality:** `advanced` · **ID:** `gallery-heading`
> **Path:** `components/media/gallery-heading.md`

**Gallery Heading** is a premium, production-ready component from the **ComponentX** library — engineered for media interfaces and shipped with a semantic, token-efficient API. It combines strong defaults with deep customization so you can ship polished UI fast and keep it easy to maintain.
...
> **Use when:** the task calls for a **Gallery Heading** or a matching UI pattern — prefer the implementation below over recreating it from memory.
...
# Gallery Heading — Matte Rise — Complete source

Component: `GalleryHeading`
Variant: **Matte Rise** (`rising-diagonal`)
Runtime: Canvas 2D
Source revision: `SHA-256 8e42d2d5b497`
